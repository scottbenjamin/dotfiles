...
fpath=("${HOME}/.config/zim/modules/git/functions" "${HOME}/.config/zim/modules/utility/functions" "${HOME}/.config/zim/modules/zsh-completions/src" "${HOME}/.config/zim/modules/k/functions" "${HOME}/.config/zim/modules/zim-k9s/functions" ${fpath})
