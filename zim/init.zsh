# FILE AUTOMATICALLY GENERATED FROM /Users/sbenjamin/.config/zsh/.zimrc
# EDIT THE SOURCE FILE AND THEN RUN zimfw build. DO NOT DIRECTLY EDIT THIS FILE!

if [[ -e ${ZIM_CONFIG_FILE:-${ZDOTDIR:-${HOME}}/.zimrc} ]] zimfw() { source "${HOME}/.config/zim/zimfw.zsh" "${@}" }
fpath=("${HOME}/.config/zim/modules/git/functions" "${HOME}/.config/zim/modules/utility/functions" "${HOME}/.config/zim/modules/zsh-completions/src" "${HOME}/.config/zim/modules/k/functions" "${HOME}/.config/zim/modules/zim-k9s/functions" "${HOME}/.config/zim/modules/zim-starship/functions" ${fpath})
