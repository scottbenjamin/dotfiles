...
fpath=("${HOME}/.config/zim/modules/git/functions" "${HOME}/.config/zim/modules/utility/functions" "${HOME}/.config/zim/modules/k/functions" ${fpath})
...
source "${HOME}/.config/zim/modules/evalcache/evalcache.plugin.zsh"
