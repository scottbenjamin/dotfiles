...
fpath=(${HOME}/.config/zim/modules/git/functions ${HOME}/.config/zim/modules/utility/functions ${HOME}/.config/zim/modules/duration-info/functions ${HOME}/.config/zim/modules/git-info/functions ${HOME}/.config/zim/modules/zsh-completions/src ${HOME}/.config/zim/modules/k/functions ${HOME}/.config/zim/modules/pvenv/functions ${HOME}/.config/zim/modules/zim-k9s/functions ${HOME}/.config/zim/modules/zim-starship/functions ${HOME}/.config/zim/modules/zim-lazygit/functions ${fpath})
